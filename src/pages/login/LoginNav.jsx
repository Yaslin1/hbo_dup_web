...
export default function LoginNav() {
  ...
  return (
    <div>
      <div className="relative z-10 h-32 bg-gradient-to-b from-black to-transparent">
    ...
    ${scrolling ? "bg-slate-950/75 backdrop-blur-sm shadow-md" : "bg-transparent"} fixed w-full z-20 top-0 left-0 `}>
          <div className="flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex md:order-2">
              <button type="button" className="text-white bg-transparent hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-4 py-2 text-center mr-10">Sign Up Now</button>
