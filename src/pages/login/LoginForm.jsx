      ...
      <div class="flex min-h-full flex-col justify-start p-14 bg-gray-300 bg-opacity-5 rounded-lg">
        ...
        <div class="">
          <form class="space-y-6" action="#" method="POST">
            ...
            <div>
              <div class="relative flex items-start justify-between flex-col">
                <label for="password" class="block text-sm font-medium leading-6 text-white">Password</label>
                <input id="password" name="password" type={showPass ? "text" : "password"} autocomplete="current-password" required class="block w-full rounded-md bg-transparent border border-white h-14 px-3 py-3.5 text-white font-normal text-base shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-400 sm:text-sm sm:leading-6 focus:outline-none focus:border-blue-400" />
